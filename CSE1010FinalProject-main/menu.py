...
## income label and button
        self.income_label = Label(self.menu, 
                                text="Enter your income.", 
                                font=("Arial",20,"bold"))
        self.income_label.pack()
        
        self.income_box = Entry(self.menu)
        self.income_box.pack()
        ...
        self.current_widgets = [self.title_label, self.name_label, self.name_box, self.submit_button,self.income_label, self.income_box]
    ...
    def show_main_menu(self):
        ...
        try:
            ...
            self.clear_screen()
            self.show_name_input_screen() 
            self.err_input = Label(menu,text="You must input a number.",font=("Arial",30,"bold"),fg="#FF0000")
            self.err_input.pack()

            self.current_widgets.append(self.err_input)
    ...
    # Category has been added screen + 3 buttons
    def show_category_confirmation(self):
        ...
        self.btn_add_expenses.pack(pady=5)
        self.btn_return_menu.pack(pady=5)

        self.current_widgets = [self.confirmation_label, self.btn_add_another, self.btn_add_expenses, self.btn_return_menu]
    ...
    def get_num_expense_screen(self, budget_instance):
        ...
        # needs to be int, if not int, refresh with error
    ...
    def record_expenses_screen(self):
        ...
        # if number of expenses is a string or a float then it refreshes with an error.
        try:
            ...
            self.err_input = Label(menu,text="You must input an integer.",font=("Arial",30,"bold"),fg="#FF0000")
            self.err_input.pack()
            self.current_widgets.append(self.err_input)
